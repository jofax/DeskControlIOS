...
public extension GridCollectionViewLayoutDelegate {
    func scaleForItem(inCollectionView collectionView: UICollectionView, withLayout layout: UICollectionViewLayout, atIndexPath indexPath: IndexPath) -> UInt {
        return 1
    }
...
open class GridCollectionViewLayout: UICollectionViewLayout, GridCollectionViewLayoutDelegate {
    ...
    weak public var delegate: GridCollectionViewLayoutDelegate?
