...
@IBDesignable class NSLayoutHelper : NSLayoutConstraint {
    ...
    @IBInspectable var iPhoneXPro: CGFloat = 0.0 {
        didSet { deviceConstant(.i6_5Inch,value:iPhoneXPro) }
    }
    @IBInspectable var iPhoneXProMax: CGFloat = 0.0 {
        didSet { deviceConstant(.i6_5Inch,value:iPhoneXProMax) }
    }
