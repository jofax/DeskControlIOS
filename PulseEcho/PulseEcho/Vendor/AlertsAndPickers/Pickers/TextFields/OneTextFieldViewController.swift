...
extension UIAlertController {
    ...
    public func addOneTextField(configuration: RLBAlertTextField.Config?) {
...
final public class OneTextFieldViewController: UIViewController {
    ...
    fileprivate lazy var textField: RLBAlertTextField = RLBAlertTextField()
    ...
    public init(vInset: CGFloat = 12, configuration: RLBAlertTextField.Config?) {
