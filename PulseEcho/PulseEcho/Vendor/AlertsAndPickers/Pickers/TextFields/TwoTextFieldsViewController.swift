...
extension UIAlertController {
    ...
    public func addTwoTextFields(height: CGFloat = 58, hInset: CGFloat = 0, vInset: CGFloat = 0, textFieldOne: RLBAlertTextField.Config?, textFieldTwo: RLBAlertTextField.Config?) {
...
final public class TwoTextFieldsViewController: UIViewController {
    ...
    fileprivate lazy var textFieldOne: RLBAlertTextField = RLBAlertTextField()
    fileprivate lazy var textFieldTwo: RLBAlertTextField = RLBAlertTextField()
    
    fileprivate var height: CGFloat
    fileprivate var hInset: CGFloat
    fileprivate var vInset: CGFloat
    
    public init(height: CGFloat, hInset: CGFloat, vInset: CGFloat, textFieldOne configurationOneFor: RLBAlertTextField.Config?, textFieldTwo configurationTwoFor: RLBAlertTextField.Config?) {
        self.height = height
        self.hInset = hInset
        self.vInset = vInset
